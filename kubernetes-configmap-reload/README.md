...
-------
    git clone https://github.com/varelajuanmartin/spring-cloud-kubernetes.git
...
--------------
    docker build -t varelajuanmartin/kubernetes-configmap-reload .
...
-----------
    docker push varelajuanmartin/kubernetes-configmap-reload
